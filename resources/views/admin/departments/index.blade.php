    ...
    <x-splade-table :for="$departments">
        @cell('action', $department)
            <div class="space-x-2">
                ...
                <Link confirm="Are you want to delete {{ $department->name }}?" confirm-button="Yes, delete!"
                    cancel-button="No" method="DELETE" href="{{ route('admin.departments.destroy', $department) }}"
