    ...
    <x-splade-table :for="$permissions">
        @cell('action', $permission)
            <div class="space-x-2">
                ...
                <Link confirm="Are you want to delete {{ $permission->name }}?" confirm-button="Yes, delete!" cancel-button="No" method="DELETE" href="{{ route('admin.permissions.destroy', $permission) }}"
